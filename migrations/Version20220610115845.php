 ...
 */
final class Version20220610115845 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE project (id INT NOT NULL, funding_id INT DEFAULT NULL, title TEXT NOT NULL, abstract TEXT NOT NULL, acronym TEXT DEFAULT NULL, start_date DATE NOT NULL, duration INT DEFAULT NULL, website TEXT DEFAULT NULL, objectives TEXT DEFAULT NULL, PRIMARY KEY(id))');
